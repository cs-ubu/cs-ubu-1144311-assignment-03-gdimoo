...
def decto32fp(req):
	if req.method == 'POST':
		...
		return render(req,'dto32.html',{'s':s,'e':e,'f':f,'conb':conb,'d':d})
	else :
		return render(req,'dto32.html')
...
def decto64fp(req):
	if req.method == 'POST':
		...
		return render(req,'dto64.html',{'s':s,'e':e,'f':f,'d':d,'conb':conb})
	else:
		return render(req,'dto64.html')
	#pass
